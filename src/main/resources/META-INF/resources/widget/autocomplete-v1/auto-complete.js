    ...
    function autoComplete(options) {
        ...
        var o = {
            ...
            onSelect: function (e, term, item) {
                var uri = data.get(term); // Récupère l'URI associée au label
                document.getElementById(options['hiddenuri']).value = uri; // Stocke l'URI dans le champ caché
            }
        };
        ...
        for (var i = 0; i < elems.length; i++) {
            ...
            that.blurHandler = function () {
                ...
                // Affichage de l'URI dans le paragraphe #output
                var uri = data.get(that.value);  // Récupère l'URI de la Map `data`
                document.getElementById(options['output']).innerHTML = 'URI du résultat : ' + uri;
