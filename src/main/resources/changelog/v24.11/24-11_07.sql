...
WHERE
    concept_group.idgroup = concept_group_concept.idgroup
...
SET idgroup = LOWER(idgroup);

UPDATE concept_group_historique
SET idgroup = LOWER(idgroup);

UPDATE concept_group_concept
SET idgroup = LOWER(idgroup);

UPDATE concept_group_label
SET idgroup = LOWER(idgroup);

UPDATE concept_group_label_historique
SET idgroup = LOWER(idgroup);