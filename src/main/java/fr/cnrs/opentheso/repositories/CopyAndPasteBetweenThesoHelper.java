...
public class CopyAndPasteBetweenThesoHelper {
    ...
    public boolean pasteBranchLikeNT(String currentIdTheso, String currentIdConcept,
        ...
        try (Connection conn = dataSource.getConnection()){
            ...
            if (!relationsHelper.addRelationBT(fromIdConcept,
                    currentIdTheso,
    ...
    public boolean pasteBranchToRoot(String currentIdTheso, String fromIdTheso, String fromIdConcept,
                                     String identifierType, int idUser, NodePreference nodePreference) {
