...
public class SelectedTheso implements Serializable {
    ...
    /**
     * capte les actions qui proviennent de la vue concept pour éviter d'initialiser la vue ! sert pour replacer l'arbre 
     */
    ...
    /**
     * initialise le nouveau thésaurus avec l'identifiant de thésaurus sélectionné
     * si la langue est fournie, on initialise dans cette langue,
