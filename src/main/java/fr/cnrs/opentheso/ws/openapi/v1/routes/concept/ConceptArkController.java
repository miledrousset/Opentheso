...
public class ConceptArkController {
    ...
    public ResponseEntity<Object> getConceptByArk(
        ...
        var datas = restRDFHelper.exportConcept(connect.openConnexionPool(), naan + "/" + idArk, HeaderHelper.removeCharset(acceptHeader));
    ...
    public ResponseEntity<Object> getIdArkOfConceptNT(
        ...
        var datas = restRDFHelper.getChildsArkId(connect.openConnexionPool(), arkId);
        return ResponseEntity.ok()
                .contentType(MediaType.APPLICATION_JSON)
                .body(Objects.requireNonNullElseGet(datas, () -> emptyMessage(APPLICATION_JSON_UTF_8)));
    }
    ...
    public ResponseEntity<Object> getPrefLabelFromArk(
        ...
        String datas = restRDFHelper.getPrefLabelFromArk(connect.openConnexionPool(), naan, idArk, lang);
        return ResponseEntity.ok()
                .contentType(MediaType.APPLICATION_JSON)
                .body(Objects.requireNonNullElseGet(datas, () -> emptyMessage(APPLICATION_JSON_UTF_8)));
    }
