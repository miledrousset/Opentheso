package fr.cnrs.opentheso.ws.openapi.scanner.io.swagger.v3.jaxrs2;
...
public class Reader implements OpenApiReader {
    ...
    public OpenAPI read(Set<Class<?>> classes) {
        ...
        Map<Class<?>, io.swagger.v3.jaxrs2.ReaderListener> listeners = new HashMap<>();

        String appPath = "";

        for (Class<?> cls : sortedClasses) {
            if (io.swagger.v3.jaxrs2.ReaderListener.class.isAssignableFrom(cls) && !listeners.containsKey(cls)) {
                try {
                    listeners.put(cls, (io.swagger.v3.jaxrs2.ReaderListener) cls.newInstance());
                } catch (Exception e) {
        ...
        for (io.swagger.v3.jaxrs2.ReaderListener listener : listeners.values()) {
            try {
    ...
    public OpenAPI read(Class<?> cls,
        ...
        if (openAPIDefinition != null) {
            ...
            io.swagger.v3.jaxrs2.SecurityParser
        ...
        if (apiSecurityScheme != null) {
            for (io.swagger.v3.oas.annotations.security.SecurityScheme securitySchemeAnnotation : apiSecurityScheme) {
                Optional<io.swagger.v3.jaxrs2.SecurityParser.SecuritySchemePair> securityScheme = io.swagger.v3.jaxrs2.SecurityParser.getSecurityScheme(securitySchemeAnnotation);
        ...
        if (apiSecurityRequirements != null) {
            Optional<List<SecurityRequirement>> requirementsObject = io.swagger.v3.jaxrs2.SecurityParser.getSecurityRequirements(
                ...
                if (operation != null) {
                    ...
                    if (annotatedMethod == null) { // annotatedMethod not null only when method with 0-2 parameters
                        ...
                        for (int i = 0; i < genericParameterTypes.length; i++) {
                            ...
                            io.swagger.v3.jaxrs2.ResolvedParameter resolvedParameter = getParameters(paramType, Arrays.asList(paramAnnotations[i]), operation, classConsumes, methodConsumes, jsonViewAnnotation);
    ...
    protected void processRequestBody(Parameter requestBodyParameter, Operation operation,
        ...
        if (requestBodyAnnotation != null) {
            Optional<RequestBody> optionalRequestBody = io.swagger.v3.jaxrs2.OperationParser.getRequestBody(requestBodyAnnotation, classConsumes, methodConsumes, components, jsonViewAnnotation);
    ...
    protected Operation parseMethod(
        ...
        if (apiSecurity != null) {
            Optional<List<SecurityRequirement>> requirementsObject = io.swagger.v3.jaxrs2.SecurityParser.getSecurityRequirements(apiSecurity.toArray(new io.swagger.v3.oas.annotations.security.SecurityRequirement[apiSecurity.size()]));
            if (requirementsObject.isPresent()) {
        ...
        if (apiRequestBody != null && operation.getRequestBody() == null){
            io.swagger.v3.jaxrs2.OperationParser.getRequestBody(apiRequestBody, classConsumes, methodConsumes, components, jsonViewAnnotation).ifPresent(
        ...
        if (classResponses != null && classResponses.length > 0) {
            io.swagger.v3.jaxrs2.OperationParser.getApiResponses(
                    classResponses,
                    classProduces,
                    methodProduces,
                    components,
    ...
    private void setOperationObjectFromApiOperationAnnotation(
        ...
        io.swagger.v3.jaxrs2.OperationParser.getApiResponses(apiOperation.responses(), classProduces, methodProduces, components, jsonViewAnnotation).ifPresent(responses -> {
            if (operation.getResponses() == null) {
                operation.setResponses(responses);
            } else {
                responses.forEach(operation.getResponses()::addApiResponse);
    ...
    protected Optional<List<Parameter>> getParametersListFromAnnotation(io.swagger.v3.oas.annotations.Parameter[] parameters, Consumes classConsumes, Consumes methodConsumes, Operation operation, JsonView jsonViewAnnotation) {
        ...
        for (io.swagger.v3.oas.annotations.Parameter parameter : parameters) {
            ...
            io.swagger.v3.jaxrs2.ResolvedParameter resolvedParameter = getParameters(ParameterProcessor.getParameterType(parameter), Collections.singletonList(parameter), operation, classConsumes, methodConsumes, jsonViewAnnotation);
    ...
    protected io.swagger.v3.jaxrs2.ResolvedParameter getParameters(Type type, List<Annotation> annotations, Operation operation, Consumes classConsumes,
