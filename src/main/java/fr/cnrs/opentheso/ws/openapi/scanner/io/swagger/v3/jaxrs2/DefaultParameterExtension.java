...
public class DefaultParameterExtension extends AbstractOpenAPIExtension {
    ...
    public io.swagger.v3.jaxrs2.ResolvedParameter extractParameters(List<Annotation> annotations,
        ...
        if (shouldIgnoreType(type, typesToSkip)) {
            return new io.swagger.v3.jaxrs2.ResolvedParameter();
        }
        ...
        for (Annotation annotation : annotations) {
            if (annotation instanceof QueryParam) {
                ...
                if (handleAdditionalAnnotation(parameters, formParameters, annotation, type, typesToSkip, classConsumes, methodConsumes, components, includeRequestBody, jsonViewAnnotation)) {
                    io.swagger.v3.jaxrs2.ResolvedParameter extractParametersResult = new io.swagger.v3.jaxrs2.ResolvedParameter();
