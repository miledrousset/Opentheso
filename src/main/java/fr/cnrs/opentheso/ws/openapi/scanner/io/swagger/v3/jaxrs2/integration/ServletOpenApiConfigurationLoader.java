package fr.cnrs.opentheso.ws.openapi.scanner.io.swagger.v3.jaxrs2.integration;
...
public class ServletOpenApiConfigurationLoader implements OpenApiConfigurationLoader {
    ...
    public OpenAPIConfiguration load(String path) throws IOException {
        ...
        String location = io.swagger.v3.jaxrs2.integration.ServletConfigContextUtils.getInitParam(servletConfig, path);
